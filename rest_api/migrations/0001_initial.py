# Generated by Django 2.2.12 on 2020-06-27 07:27
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('race', models.CharField(blank=True, max_length=255, null=True, verbose_name='Raza')),
                ...
                ('vaccination_plan', ckeditor.fields.RichTextField(verbose_name='Plan vacunatorio')),
            ],
            options={
                'verbose_name': 'Animal',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('default_vaccination_plan', ckeditor.fields.RichTextField(verbose_name='Plan vacunatorio por default')),
            ],
        ),
        migrations.CreateModel(
            name='Colaboration',
        ...
        migrations.CreateModel(
            name='ColaborationColaborators',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('status_request', models.CharField(default='Reservado', max_length=30, verbose_name='Estado de colaboración')),
                ('colaboration', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='colaboration_colab', to='rest_api.Colaboration', verbose_name='Colaboration')),
                ('colaborator', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='colaboration_users', to='rest_api.Profile', verbose_name='Colaborators')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='animal',
            name='species',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='animal_specie', to='rest_api.AnimalSpecie', verbose_name='Especie'),
        ),
        migrations.CreateModel(
            name='AdoptionRequest',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('status', models.CharField(choices=[('Disponible', 'Disponible'), ('Solicitado', 'Solicitado'), ('En espera', 'En espera'), ('Aceptado', 'Aceptado'), ('Rechazado', 'Rechazado'), ('En revisión', 'En revisión'), ('Adoptado', 'Adoptado'), ('Eliminado', 'Eliminado')], default='Disponible', max_length=30, verbose_name='Estado de petición')),
