...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('status', models.CharField(choices=[('Disponible', 'Disponible'), ('Comenzo', 'Comenzo'), ('En espera', 'En espera'), ('Aceptado', 'Aceptado'), ('Rechazado', 'Rechazado'), ('En revisión', 'En revisión'), ('Adoptado', 'Adoptado')], default='Disponible', max_length=3, verbose_name='Estado de petición')),
