# Generated by Django 2.2.12 on 2020-05-05 23:55
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('status', models.CharField(choices=[('STA', 'Comenzo'), ('WAL', 'En espera'), ('ACC', 'Aceptado'), ('REJ', 'Rechazado'), ('ONH', 'En revisión'), ('ADO', 'Adoptado')], default='STA', max_length=3, verbose_name='Tipo de Perfil')),
